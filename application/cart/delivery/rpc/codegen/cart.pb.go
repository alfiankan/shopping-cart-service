...
func (x *EmptyDataResponse) Reset() {
	*x = EmptyDataResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *EmptyDataResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EmptyDataResponse) ProtoMessage() {}

func (x *EmptyDataResponse) ProtoReflect() protoreflect.Message {
	mi := &file_cart_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EmptyDataResponse.ProtoReflect.Descriptor instead.
func (*EmptyDataResponse) Descriptor() ([]byte, []int) {
	return file_cart_proto_rawDescGZIP(), []int{1}
}

func (x *EmptyDataResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *EmptyDataResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *EmptyDataResponse) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_cart_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x53, 0x0a, 0x11, 0x45, 0x6d,
	0x70, 0x74, 0x79, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	...
	0x53, 0x0a, 0x0b, 0x43, 0x61, 0x72, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x44,
	0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61, 0x72, 0x74, 0x12, 0x0d, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x45, 0x6d,
	0x70, 0x74, 0x79, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x13, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0d, 0x3a, 0x01, 0x2a, 0x22, 0x08, 0x2f, 0x76, 0x31, 0x2f,
	0x63, 0x61, 0x72, 0x74, 0x42, 0x17, 0x5a, 0x15, 0x2e, 0x2f, 0x63, 0x61, 0x72, 0x74, 0x5f, 0x67,
	0x72, 0x70, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x62, 0x06, 0x70,
...
var file_cart_proto_goTypes = []interface{}{
	...
	(*EmptyDataResponse)(nil), // 1: EmptyDataResponse
}
var file_cart_proto_depIdxs = []int32{
	0, // 0: CartService.CreateCart:input_type -> EmptyRequest
	1, // 1: CartService.CreateCart:output_type -> EmptyDataResponse
...
func file_cart_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cart_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EmptyDataResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
