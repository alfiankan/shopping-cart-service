...
type ICartRepository interface {
	...
	GetItemByProductID(ctx context.Context, cartID, productCode uuid.UUID) (item CartItem, err error)

	UpdateQtyByProductID(ctx context.Context, cartID, productCode uuid.UUID, qty int) (ok bool)
